...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn =findViewById(R.id.button_main_activity);
        im_main =findViewById(R.id.firist_main_image);
        im_second=findViewById(R.id.second_main_image);
